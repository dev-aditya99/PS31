  ...
  <section className="py-16 bg-gray-50">
    <div className="container mx-auto px-6">
      <h2 className="text-3xl font-bold text-center mb-10 text-gray-800">
        Discover Our Popular Career Paths
      </h2>
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        <CourseCard
          img="https://placehold.co/600x400/1976d2/ffffff?text=MERN+Stack"
          title="Full-Stack MERN Development"
          desc="Master the MERN stack and build real-world applications from scratch."
          level="Advanced"
        />
        <CourseCard
          img="https://placehold.co/600x400/388e3c/ffffff?text=Data+Science"
          title="Data Science with Python"
          desc="Unlock insights from data using Python, Pandas, and Scikit-learn."
          level="Intermediate"
        />
        <CourseCard
          img="https://placehold.co/600x400/f57c00/ffffff?text=UI/UX+Design"
          title="UI/UX Design Fundamentals"
          desc="Learn the principles of user-centric design with Figma and Adobe XD."
          level="Beginner"
        />
      </div>
    </div>
    ...
    <div className="container mx-auto px-6 flex flex-wrap lg:flex-nowrap items-center justify-center gap-12">
      ...
      <div className="w-full lg:w-1/2 text-center lg:text-left">
        ...
        <p className="text-gray-600 mb-8">
          We are committed to providing a world-class learning experience with
          measurable results and a supportive community.
        </p>
        <div className="flex justify-center lg:justify-start space-x-8">
          ...
          <div className="text-center">
            <Star className="w-10 h-10 mx-auto mb-2 fill-current text-yellow-500" />
